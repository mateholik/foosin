          ...
          <ul className="space-y-3 md:hidden">
            {rows.map((row, index) => (
              ...
              >
                ...
                <p className="mt-3 text-xl font-semibold text-slate-100">{row.teamName}</p>
            ...
            <table className="min-w-full text-left text-sm">
              <thead>
                <tr className="border-b border-white/10 text-slate-400">
                  ...
                  <th className="pb-3 pr-4 text-xs font-medium uppercase tracking-wide">Team</th>
              ...
              <tbody>
                {rows.map((row, index) => (
                  <tr key={row.teamId} className="border-b border-white/10 last:border-0">
                    <td className="py-3 pr-4 font-medium text-slate-400">{index + 1}</td>
                    <td className="py-3 pr-4">
                      <p className="text-base font-semibold text-slate-100">{row.teamName}</p>
